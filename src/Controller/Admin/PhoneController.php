...
class PhoneController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/phone/new.html.twig', [
            'phone' => $phone,
            'form' => $form,
        ]);
    }
    ...
    public function newPhone(Request $request, PhoneRepository $phoneRepository, EntityManagerInterface $entityManager): Response
    {
        $reponse = [
            'reponse' => false,
            'error' => 1
    ...
    public function edit(Request $request, Phone $phone, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/phone/edit.html.twig', [
            'phone' => $phone,
            'form' => $form,
        ]);
    }
    ...
    public function editPhone(Request $request, Phone $phone, PhoneRepository $phoneRepository, EntityManagerInterface $entityManager): Response
    {
        $reponse = [
            'reponse' => false,
            'error' => 1
    ...
    public function deletePhone(Request $request, Phone $phone, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete' . $phone->getId(), $request->request->get('_token'))) {
            $entityManager->remove($phone);
            $entityManager->flush();
